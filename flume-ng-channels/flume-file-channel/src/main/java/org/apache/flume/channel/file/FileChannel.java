...
public class FileChannel extends BasicChannelSemantics {
    ...
    public synchronized void start() {
        ...
        try {
            ...
            //以上是将configure方法获取到的参数，set到Builder对象
            log = builder.build();
    ...
    static class FileBackedTransaction extends BasicTransactionSemantics {
        ...
        @Override
        protected void doPut(Event event) throws InterruptedException {  //doPut()：source会调用put方法
            ...
            log.lockShared();
            try {//transactionID是在TransactionIDOracle类中递增的
        ...
        @Override
        protected Event doTake() throws InterruptedException { // doTake()：sink会调用take方法
        ...
        @Override
        protected void doCommit() throws InterruptedException { // doCommit()：source和sink都会调用该方法提交事务
